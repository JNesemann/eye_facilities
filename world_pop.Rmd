...
#                      destDir = "~/Library/Mobile Documents/com~apple~CloudDocs/R projects/eye_facilities/data/pop") # directory on computer to download the files
...
# m50to54 <- raster(here("data", "pop", "mwi_agesex_m_50_2020_constrained.tif"))
# names(m50to54) <- "m_50" # look at the raster attributes, it is a RasterLayer
# m55to59 <- raster(here("data", "pop", "mwi_agesex_m_55_2020_constrained.tif"))
# names(m55to59) <- "m_55"
# 
# # creating a stack
...
#   # writeRaster(popsum, here("data", "pop_constrained", "popsum_constrained.tif"))
```
...
popsum <- raster(here("data", "pop_constrained", "popsum_constrained.tif"))

# plotting with tmap
tm_shape(malawi) + tm_polygons() +
  tm_shape(popsum) +
...
#   
#   # saving the newly created raster
#   # writeRaster(popsum.unconst, here("data", "pop_unconstrained", "popsum_unconstrained.tif"))

#### PLOTTING WITH TMAP ####
  # Opening the tiff file created above (can do this instead of downloading and mergin everything everytime you run the code)
  popsum.unconst <- raster(here("data", "pop_unconstrained", "popsum_unconstrained.tif"))
