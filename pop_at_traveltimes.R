...
access.motor.surgperm <- raster(here("data","rasters","traveltimes", "motor travel time",
                                 "access_motor_surgery_perm.tif"))

access.motor.surg <-  raster(here("data","rasters","traveltimes","motor travel time",
                                        "access_motor_surgery.tif"))

access.motor.all <- raster(here("data","rasters","traveltimes","motor travel time",
                                    "access_motor_all.tif"))


# walking travel times
access.walk.all <- raster(here("data","rasters","traveltimes","walk travel time",
                                  "access_walk_all.tif"))

access.walk.surg <- raster(here("data","rasters","traveltimes","walk travel time",
                                   "access_walk_surg.tif"))

access.walk.surgperm <- raster(here("data","rasters","traveltimes","walk travel time",
...
# admin 1 boundaries
adm1 <- st_read(here("data","mwi_adm_nso_20181016_shp.nosync","mwi_admbnda_adm1_nso_20181016.shp"))
...
tmap_save(motor.all.plot, here("results","maps","motor_all.png"))
...
motor.surg.plot <- tm_shape(motor.surg.cat) +
  ...
  tm_layout(main.title = "B) Motorized travel time to nearest eye care facility\nwith cataract surgical services",
            ...
            main.title.position = "left")
motor.surg.plot 
tmap_save(motor.surg.plot, here("results","maps","motor_surg.png"))
...
motor.surgperm.plot <- tm_shape(motor.surgperm.cat) +
  ...
  tm_layout(main.title = "C) Motorized travel time to nearest eye care facility\nwith permanent cataract surgical services",
            ...
            main.title.position = "left")
motor.surgperm.plot 
tmap_save(motor.surgperm.plot, here("results","maps","motor_surgperm.png"))
...
walk.all.plot <- tm_shape(walk.all.cat) +
  ...
  tm_layout(main.title = "D) Walking travel time to nearest eye care facility",
            ...
            main.title.position = "left")
walk.all.plot 
tmap_save(walk.all.plot , here("results","maps","walk_all.png"))
...
walk.surg.plot <- tm_shape(walk.surg.cat) +
  ...
  tm_layout(main.title = "E) Walking travel time to nearest eye care facility\nwith cataract surgical services",
            ...
            main.title.position = "left")
walk.surg.plot 
tmap_save(walk.surg.plot , here("results","maps","walk_surg.png"))
...
walk.surgperm.plot <- tm_shape(walk.surgperm.cat) +
  ...
  tm_layout(main.title = "F) Walking travel time to nearest eye care facility\nwith permanent cataract surgical services",
            ...
            main.title.position = "left")
walk.surgperm.plot 
tmap_save(walk.surgperm.plot  , here("results","maps","walk_surgperm.png"))
...
write_csv(table, here("results","tables","traveltime_motorwalk.csv"))
