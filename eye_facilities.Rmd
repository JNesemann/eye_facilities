...
malawi <- st_read(here("data", "mwi_admbnda_adm2_nso_20181016.shp"))
```
...
```{r}
malawi_clip <- readRDS((here("data", "gadm36_MWI_0_sp.rds"))) # "geo_shp", 
...
print(full_plot)
```
>>>>>>> 655340edbaa4770eb735c9e5c87e1680dcaaacb7
